                        ...
                        <div id="search-top" class="pull-right small-screens hidden-sm hidden-md hidden-lg">
                            <span id="dnn_dnnSearch2_ClassicSearch">
                                ...
                                <span class="searchInputContainer" data-moreresults="See More Results" data-noresult="No Results Found">
                                    <input name="dnn$dnnSearch2$txtSearch" type="text" maxlength="255" size="20" id="dnn_dnnSearch2_txtSearch"
                                           class="NormalTextBox" aria-label="Search" autocomplete="off" placeholder="Search...">
                                    <a class="dnnSearchBoxClearText" title="Clear search text"></a>
                                </span>
                                <a id="dnn_dnnSearch2_cmdSearch" class="SearchButton"
                                   href="javascript:__doPostBack(&#39;dnn$dnnSearch2$cmdSearch&#39;,&#39;&#39;)">Search</a>
                            </span>
                    ...
                    <div class="col-md-12">
                        <div class="search">
                            <span id="dnn_dnnSearch_ClassicSearch">
                                ...
                                <a id="dnn_dnnSearch_cmdSearch" class="SearchButton"
                                   href="javascript:__doPostBack(&#39;dnn$dnnSearch$cmdSearch&#39;,&#39;&#39;)">Search</a><span
                ...
                <ul class="nav navbar-nav sm" data-smartmenus-id="16459200511787002">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" id="sm-16459200511787002-4" role="group" aria-hidden="true"
                            ...
                            <li><a href="{{url('/the-loai') .'/'. array_search(\App\Enums\PostType::DBTT, $postType)}}">{{\App\Enums\PostType::DBTT}}</a></li>
                            <li><a href="{{url('/the-loai') .'/'. array_search(\App\Enums\PostType::BTTT, $postType)}}">{{\App\Enums\PostType::BTTT}}</a></li>
                            <li><a href="{{url('/the-loai') .'/'. array_search(\App\Enums\PostType::TTSK, $postType)}}">{{\App\Enums\PostType::TTSK}}</a></li>
                            <li><a href="{{url('/the-loai') .'/'. array_search(\App\Enums\PostType::TLTT, $postType)}}">Hướng dẫn, phổ biến kiến thức</a></li>
                        </ul>
                    </li>
                    <li>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body" style="padding: 0">
                                    <div class="list-group" style="margin-bottom: 0px;">
                                        ...
                                        <a target="_blank" href="https://earth.nullschool.net/" class="list-group-item"><strong>
                                                <i class="fa fa-globe" aria-hidden="true"></i>
